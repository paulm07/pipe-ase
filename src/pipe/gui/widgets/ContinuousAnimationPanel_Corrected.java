 ...
 */
public class ContinuousAnimationPanel_Corrected extends JPanel {
    ...
    public ContinuousAnimationPanel_Corrected(final Animator pAnimator, final DataLayer pDataLayer) {
